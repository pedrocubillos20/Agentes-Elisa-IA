  ...
  const plans = [
    {
      ...
      period: '/mes USD',
      color: 'blue',
      features: ['1 línea WhatsApp', 'Asistente IA', 'Conversaciones ilimitadas', 'Base de conocimiento'],
      popular: false,
    },
    {
      id: 'business',
      ...
      period: '/mes USD',
      color: 'purple',
      features: ['Líneas ilimitadas', 'CRM + Pipeline', 'Agenda automática', 'Equipo completo', 'Integraciones API'],
      popular: true,
    },
  ];
