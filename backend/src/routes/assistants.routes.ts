...
router.post('/', async (req: Request, res: Response) => {
  try {
    ...
    const data: any = {
      ...
      ...(body.modZonas !== undefined && { modZonas: body.modZonas || null }),
      ...(body.modMemoriaCliente !== undefined && { modMemoriaCliente: body.modMemoriaCliente || null }),
      ...(body.modMetricas !== undefined && { modMetricas: body.modMetricas || null }),
      ...(body.modDetector !== undefined && { modDetector: body.modDetector || null }),
      ...(body.modTriggers !== undefined && { modTriggers: body.modTriggers || null }),
